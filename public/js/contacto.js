...
function validateName(){
    ...
    if(name.length == 0){
        nameError.innerHTML = 'Ingresar su nombre';
        return false;
    }
...
function validatePhone(){
    ...
    if(phone.length == 0){
        phoneError.innerHTML = 'Ingresar su teléfono';
        return false;
    }
    if(phone.length !== 10){
        phoneError.innerHTML = 'minimos 10 digitos';
        return false;
    }
    if(!phone.match(/^[0-9]{10}$/)){
        phoneError.innerHTML = 'Ingresar digitos';
        return false;
    }
...
function validateEmail(){
    ...
    if(email.length == 0){
        emailError.innerHTML = 'Ingresar email';
        return false;
    }
...
function validateFrom(){
    if(!validateName() || !validatePhone() || !validateEmail() || !validateMessage()){
        ...
        submitError.innerHTML = 'Rellenar los campos';
